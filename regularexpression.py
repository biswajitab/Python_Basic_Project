...
# f= open("regularexpression.txt","r")
# data=f.read()

# # Search for a pattern: one or more uppercase letters followed by a lowercase letter
# dataa = re.findall(r"[A-Z]+[a-z]{2,10}", data)
# print(dataa)


# var = "my mobile nums are 7411694426 and 9986019197 abcd"
# # inxd =var.find("kkk")
# # print(inxd)
# # #
# #
...
# pat = r'[0-9]{10}'
# sec=r'[a-z]{4,5}'
# print(re.findall(pat,var))
# print(re.findall(sec,var))
...
# fvar = open(r'regularexpression.txt', 'r')
# data = fvar.read()
# fvar.close()
#
# patn = '[A-Z][a-z]{1,}'
...
# var="mykk name is biswajit das"
# ptrn='[^mykk]'
# check=re.search(ptrn,var)
# print(check)

#
# var='mykk name  biswajit das'
# hello=re.search(r"^mykk",var)
# print(hello)
...
#
# adata_formatted = re.sub('[0-9]{10}','9898989898', adata)
# print(adata_formatted)
